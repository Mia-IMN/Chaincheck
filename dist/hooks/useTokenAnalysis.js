...
exports.useTokenAnalysis = void 0;
const react_1 = require("react");
const useTokenAnalysis = (token) => {
    const [analysis, setAnalysis] = (0, react_1.useState)(null);
    const [loading, setLoading] = (0, react_1.useState)(false);
    const generateAnalysis = (tokenData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const analyzeToken = (0, react_1.useCallback)((tokenData) => __awaiter(void 0, void 0, void 0, function* () {
        if (!tokenData)
            return;
        setLoading(true);
        try {
            const analysisResult = yield generateAnalysis(tokenData);
...
exports.useTokenAnalysis = useTokenAnalysis;
