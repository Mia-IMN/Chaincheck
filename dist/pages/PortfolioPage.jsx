...
const PortfolioPage = ({ isDark }) => {
    ...
    return (<div className="min-h-screen pt-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <div className={`p-16 rounded-3xl backdrop-blur-sm border ${isDark
          ...
          <div className="w-24 h-24 mx-auto mb-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center">
            <lucide_react_1.BarChart3 className="w-12 h-12 text-white"/>
          </div>
          ...
          <div className={`inline-flex items-center gap-3 px-6 py-3 rounded-full border ${isDark
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            {features.map((feature, index) => (<div key={index} className={`p-6 rounded-xl border ${isDark
                ? 'bg-white/5 border-white/10'
